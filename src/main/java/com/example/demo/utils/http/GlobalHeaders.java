...
public enum GlobalHeaders{
	...
	public GlobalHeaders putDefault(boolean isReset) {
		...
		header(cn.hutool.http.Header.ACCEPT, "text/html,application/xhtml+xml,application/xml,application/json;q=0.9,*/*;q=0.8", true);
		header(cn.hutool.http.Header.ACCEPT_ENCODING, "gzip", true);
		header(cn.hutool.http.Header.ACCEPT_LANGUAGE, "zh-CN,zh;q=0.8", true);
		header(cn.hutool.http.Header.CONTENT_TYPE, "application/x-www-form-urlencoded", true);
		header(cn.hutool.http.Header.USER_AGENT, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.84 Safari/537.36 Hutool", true);
		return this;
	}
	 ...
	 * @return this
	 */
	public GlobalHeaders header(cn.hutool.http.Header name, String value, boolean isOverride) {
	 ...
	 * @return this
	 */
	public GlobalHeaders header(cn.hutool.http.Header name, String value) {
