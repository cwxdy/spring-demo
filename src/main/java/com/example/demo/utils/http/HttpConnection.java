...
public class HttpConnection {
	...
	private URL url;
	/** method请求方法 */
	private cn.hutool.http.Method method;
	private Proxy proxy;
	 ...
	 */
	public static HttpConnection create(String urlStr, cn.hutool.http.Method method) {
	 ...
	 * @return HttpConnection
	 */
	public static HttpConnection create(String urlStr, cn.hutool.http.Method method, int timeout) {
	 ...
	 * @return HttpConnection
	 */
	public static HttpConnection create(String urlStr, cn.hutool.http.Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf) {
	 ...
	 * @return HttpConnection
	 */
	public static HttpConnection create(String urlStr, cn.hutool.http.Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf, int timeout, Proxy proxy) {
	 ...
	 * @since 4.1.9
	 */
	public static HttpConnection create(URL url, cn.hutool.http.Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf, int timeout, Proxy proxy) {
	 ...
	 * @param method HTTP方法
	 */
	public HttpConnection(String urlStr, cn.hutool.http.Method method) {
	 ...
	 * @param timeout 超时时长
	 */
	public HttpConnection(String urlStr, cn.hutool.http.Method method, int timeout) {
	 ...
	 * @param proxy 代理
	 */
	public HttpConnection(String urlStr, cn.hutool.http.Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf, int timeout, Proxy proxy) {
	 ...
	 * @param proxy 代理
	 */
	public HttpConnection(URL url, cn.hutool.http.Method method, HostnameVerifier hostnameVerifier, SSLSocketFactory ssf, int timeout, Proxy proxy) {
		this.url = url;
		this.method = ObjectUtil.isNull(method) ? cn.hutool.http.Method.GET : method;
		this.proxy = proxy;

		try {
			this.conn = openHttp(hostnameVerifier, ssf);
		} catch (Exception e) {
			throw new cn.hutool.http.HttpException(e.getMessage(), e);
		}
		if (timeout > 0) {
	...
	public HttpConnection initConn() {
		...
		if (cn.hutool.http.Method.POST.equals(this.method) || cn.hutool.http.Method.PUT.equals(this.method) || cn.hutool.http.Method.PATCH.equals(this.method) || cn.hutool.http.Method.DELETE.equals(this.method)) {
	 ...
	 */
	public cn.hutool.http.Method getMethod() {
		return method;
	}
	 ...
	 * @return HttpConnection
	 */
	public HttpConnection header(cn.hutool.http.Header header, String value, boolean isOverride) {
	 ...
	 * @return Http请求头值
	 */
	public String header(cn.hutool.http.Header name) {
